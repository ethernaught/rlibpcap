...
impl ArpExtension {
    ...
    pub fn set_protocol_type(&mut self, protocol_type: Types) {
        self.protocol_type = protocol_type;
    }

    pub fn get_protocol_type(&self) -> Types {
        self.protocol_type
    }
...
impl Layer for ArpExtension {
    ...
    fn from_bytes(buf: &[u8]) -> Option<Self> {
        ...
        Some(Self {
            ...
            protocol_type: Types::from_code(u16::from_be_bytes([buf[2], buf[3]])).unwrap(),
            hardware_size: buf[4],
            protocol_size: buf[5],
